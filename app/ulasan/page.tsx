      ...
      <main>
        ...
        <section className="relative overflow-hidden pt-16 pb-12 bg-surface">
          <div className="max-w-container-max mx-auto px-margin-desktop text-center">
            <h1 className="mb-6 max-w-4xl text-4xl font-extrabold leading-tight tracking-tight text-on-surface md:text-6xl lg:text-7xl font-headline mx-auto">
              Kisah <span className="text-secondary">Sukses</span> Bersama KompasKarir
            </h1>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto">
              Ribuan pelajar dan profesional telah menemukan jalur karir impian mereka melalui
              analisis RIASEC yang didukung oleh presisi AI.
            </p>
          </div>
        ...
        <section className="max-w-container-max mx-auto px-4 md:px-12 mb-20">
          <h2 className="font-display-md text-headline-md text-on-surface text-center mb-10">
            Testimoni Pengguna
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((testimoni) => (
              <div
                key={testimoni.id}
                className="bg-surface-container-low border border-outline-variant/30 rounded-xl p-6 flex flex-col h-full hover:shadow-md transition-shadow"
              >
        ...
        <section className="text-on-surface py-20">
          <div className="max-w-container-max mx-auto px-4 md:px-12 text-center">
            <h2 className="font-display-md text-headline-md mb-4">
              Temukan Potensi Karir Anda Sekarang!
            </h2>
            <p className="font-body-md text-body-md text-on-surface-variant mb-10">
              Bergabunglah dengan puluhan ribu pengguna yang telah sukses menemukan jalur karir
              impian mereka.
            </p>
            <Button href="/instruksi" size="lg" variant="primary" className="font-headline">
              Mulai Tes Sekarang <FaArrowRight className="ml-2" />
            </Button>
          </div>
        </section>
      </main>
